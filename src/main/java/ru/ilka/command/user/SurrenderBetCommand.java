 ...
 */
public class SurrenderBetCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        ...
        try {
            gameLogic.concludeGame(betPlace, LogicResult.SURRENDER,deal,account);
        } catch (LogicException e) {
            throw new CommandException("Error while trying to surrender " + e);
        }
